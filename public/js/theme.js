(function($) {
    ...
    $(window).on('load', function() {
        ...
        if ($('.home-testimonial').length) {
            ...
            $('.testimonials-one__nav-left').on('click', function() {
                $('.home-testimonial').trigger('next.owl.carousel');
                return false;
            });
            $('.testimonials-one__nav-right').on('click', function() {
                $('.home-testimonial').trigger('prev.owl.carousel');
                return false;
            });
        }

        if ($('.about-testimonial').length) {
            ...
            $('.testimonials-one__nav-left').on('click', function() {
                $('.about-testimonial').trigger('next.owl.carousel');
                return false;
            });
            $('.testimonials-one__nav-right').on('click', function() {
                $('.about-testimonial').trigger('prev.owl.carousel');
                return false;
            });
        }
